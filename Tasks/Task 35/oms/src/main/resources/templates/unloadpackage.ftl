...
<div>
    <fieldset>
        ...
        <form name="unloadpackage" action="" method="POST">
            <table>
                <tr><td>Наименование</td><td><input type = "text" name = "name" value="${unloadpackage.name}" ></td></tr>
                ...
                <tr><td>Дата начало</td><td><input type = "date" name = "startDate" value=${unloadpackage.startDate!""}></td></tr>
                <tr><td>Дата окончания</td><td><input type = "date" name = "endDate" value=${unloadpackage.endDate!""}></td></tr>
